...
export class CloudStorage {
  ...
  static listenToJournalEntries(callback: (entries: JournalEntry[]) => void): Unsubscribe {
  ...
  static listenToWishlistItems(callback: (items: WishlistItem[]) => void): Unsubscribe {
  ...
  static listenToCharlieData(callback: (data: { image: string; description: string }) => void): Unsubscribe {

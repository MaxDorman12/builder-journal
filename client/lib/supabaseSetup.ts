...
export class SupabaseSetup {
  ...
  static displaySetupInstructions(): void {
    ...
    console.log('')
    console.log('SOLUTION: Disable RLS or Create Public Policy')
    console.log('==========================================')
    console.log('METHOD 1 - Disable RLS (EASIEST):')
    console.log('1. Go to Storage > journal-media bucket')
    console.log('2. Click "Policies" tab')
    console.log('3. Find "Row Level Security" toggle')
    console.log('4. Turn it OFF (disable)')
